import{j as e}from"./vendor-BlNF5je7.js";import{D as i,S as l,C as t,O as r,N as n,W as s,B as a,E as o,R as d,a as c}from"./subject-01-fundamentals-DsAKErwb.js";function h(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"Pointers are one of the most powerful features of C++. A pointer is a variable that stores the memory address of another variable. Understanding pointers is essential for dynamic memory allocation, efficient data structures, and low-level system programming."}),e.jsx(i,{title:"What is a Pointer?",children:e.jsxs("p",{children:["A ",e.jsx("strong",{children:"pointer"})," is a variable whose value is the memory address of another object or function. Pointers allow indirect access to data, enabling efficient manipulation of arrays, dynamic memory, and complex data structures."]})}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Declaring and Using Pointers"}),e.jsxs(l,{title:"Pointer Declaration",children:[e.jsxs("p",{children:["A pointer is declared by placing an asterisk (",e.jsx("code",{children:"*"}),") between the type and the variable name. The ",e.jsx("strong",{children:"address-of operator"})," (",e.jsx("code",{children:"&"}),") retrieves the memory address of a variable."]}),e.jsx(t,{children:`Type* pointerName;          // pointer to Type
