import{j as e}from"./vendor-BlNF5je7.js";import{D as s,C as t,O as r,S as i,N as n,B as o,W as c,E as a,R as d,a as l}from"./subject-01-fundamentals-Co6V3RzB.js";function u(){return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:[e.jsx("code",{children:"std::vector"})," is the most commonly used container in C++. It provides a dynamic array that manages its own memory, grows automatically when elements are added, and provides fast random access to elements. If you need a collection of elements and are unsure which container to use, ",e.jsx("code",{children:"std::vector"})," is almost always the right default choice."]}),e.jsx(s,{title:"std::vector",children:e.jsxs("p",{children:["A sequence container that encapsulates a dynamic-size array. Elements are stored contiguously in memory, which means pointer arithmetic and cache-friendly traversal work just as they do with raw arrays. Defined in the ",e.jsx("code",{children:"<vector>"})," header."]})}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Creating and Using Vectors"}),e.jsx(t,{title:"vector_basics.cpp",children:`#include <iostream>
#include <vector>
