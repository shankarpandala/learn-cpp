    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950/50">
      <div className="mx-auto max-w-4xl px-6 py-10">
        ...
        <p className="mt-1 text-gray-500 dark:text-gray-400">
          Track your C++ learning journey across all subjects.
        </p>
        ...
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            <div className="text-center sm:text-left">
              <div className="text-5xl font-extrabold text-blue-600 dark:text-blue-400 tabular-nums">
                {totalCompleted}
              </div>
              ...
              {subjectProgress.map(({ subject, completed, total, percent }, idx) => (
                ...
                >
                  <Link
                    ...
                    className="flex items-center gap-3 rounded-xl border border-gray-200 bg-white p-4 hover:shadow-sm transition-shadow dark:border-gray-800 dark:bg-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                  >
                    <span
                  ...
                  {recent.map((item, idx) => (
                    ...
                    >
                      <Link
                        ...
                        className="flex items-start gap-2.5 rounded-lg border border-gray-200 bg-white p-3 text-sm hover:border-emerald-300 hover:bg-emerald-50/30 transition-colors dark:border-gray-800 dark:bg-gray-900 dark:hover:border-emerald-800/50 dark:hover:bg-emerald-950/10"
                      >
                        <CheckIcon />
                  ...
                  {bookmarks.map((bm, idx) => (
                    ...
                    >
                      <Link
                        ...
                        className="flex flex-1 items-start gap-2 text-sm min-w-0 rounded"
                      >
                        <BookmarkIcon />
                      ...
                      <button
                        ...
                        className="shrink-0 rounded p-1 text-gray-400 hover:bg-gray-100 hover:text-red-500 dark:text-gray-500 dark:hover:bg-gray-800 dark:hover:text-red-400"
