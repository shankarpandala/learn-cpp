...
Welcome to C++.`}),e.jsx(l,{title:"Modify the Program",difficulty:"beginner",prompt:"Modify the Hello World program to print your name on a separate line after 'Hello, World!'.",hints:["Add another std::cout statement after the first one","Use std::endl or '\\n' to create a new line"],solution:e.jsx(t,{children:`#include <iostream>

int main() {
    std::cout << "Hello, World!" << std::endl;
    std::cout << "My name is Alice." << std::endl;
    return 0;
}`})}),e.jsx(l,{title:"Print a Pattern",difficulty:"beginner",prompt:"Write a program that prints a simple triangle pattern using asterisks (*).",hints:["Use multiple std::cout statements, one per line","Each line should have one more asterisk than the previous"],solution:e.jsx(t,{children:`#include <iostream>
...
./program`}),e.jsx(r,{children:"Hello from greet()!"}),e.jsx(l,{title:"Identify the Error Type",difficulty:"beginner",prompt:"For each of these errors, determine if it's a preprocessor error, compiler error, or linker error: (1) misspelled header name, (2) missing semicolon, (3) calling a function that's declared but not defined.",solution:e.jsxs("div",{className:"text-sm text-gray-700 dark:text-gray-300 space-y-1",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"1."})," Preprocessor error — the #include directive fails"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"2."})," Compiler error — syntax violation"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"3."})," Linker error — undefined reference"]})]})}),e.jsx(x,{references:[{type:"cppreference",title:"Translation phases",url:"https://en.cppreference.com/w/cpp/language/translation_phases",description:"Official phases of C++ translation"},{type:"textbook",title:"The C++ Programming Language",author:"Bjarne Stroustrup",description:"Chapter 2.2: Programs"}]})]})}const G=Object.freeze(Object.defineProperty({__proto__:null,default:W},Symbol.toStringTag,{value:"Module"}));function z(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"A well-structured C++ program separates concerns into headers and source files, organizes code with namespaces, and uses comments to explain intent. Understanding these structural elements is essential before writing larger programs."}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Headers and Source Files"}),e.jsx(c,{title:"Header Files (.h / .hpp)",children:e.jsxs("p",{children:["Header files contain ",e.jsx("strong",{children:"declarations"})," — function prototypes, class definitions, constants, and type aliases. They tell the compiler ",e.jsx("em",{children:"what exists"})," without providing the full implementation."]})}),e.jsx(c,{title:"Source Files (.cpp)",children:e.jsxs("p",{children:["Source files contain ",e.jsx("strong",{children:"definitions"})," — the actual implementations of functions and methods. Each source file is compiled independently into an object file."]})}),e.jsx(t,{title:"math_utils.h",children:`#ifndef MATH_UTILS_H
#define MATH_UTILS_H
...
3 * 4 = 12`}),e.jsxs(d,{title:"Include Guards",children:[e.jsx("p",{children:"Include guards prevent a header from being included multiple times in the same translation unit, which would cause redefinition errors."}),e.jsx(t,{children:`// Traditional include guard
...
#pragma once
// ... declarations ...`})]}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Namespaces"}),e.jsx(c,{title:"Namespace",children:e.jsx("p",{children:"A namespace is a declarative region that provides a scope for identifiers inside it. Namespaces prevent name collisions when combining code from different libraries."})}),e.jsx(t,{title:"Using namespaces",children:`#include <iostream>
...
INT_MAX: 2147483647`}),e.jsx(a,{type:"tip",title:"Digit Separators (C++14)",children:e.jsxs("p",{children:["Use single quotes as digit separators for readability: ",e.jsx("code",{children:"1'000'000"})," instead of ",e.jsx("code",{children:"1000000"}),". The compiler ignores them entirely."]})}),e.jsxs(d,{title:"Unsigned Types",children:[e.jsxs("p",{children:["Adding ",e.jsx("code",{children:"unsigned"})," before an integer type makes it non-negative, doubling the positive range at the cost of no negative values."]}),e.jsx(t,{children:`unsigned int positive = 42;      // 0 to ~4.2 billion
unsigned short small = 65535;    // 0 to 65,535`})]}),e.jsxs(m,{title:"Unsigned Underflow",children:[e.jsx("p",{children:"Subtracting from an unsigned value that reaches 0 wraps around to a huge number instead of going negative. This is a common source of bugs."}),e.jsx(t,{children:`unsigned int x = 0;
...
int main() {
    ...
    return 0;
}`}),e.jsx(a,{type:"info",title:"Guaranteed Minimums",children:e.jsxs("p",{children:["The C++ standard only guarantees ",e.jsx("em",{children:"minimum"})," sizes: ",e.jsx("code",{children:"char"})," is at least 1 byte,",e.jsx("code",{children:"short"})," at least 2, ",e.jsx("code",{children:"int"})," at least 2, ",e.jsx("code",{children:"long"})," at least 4,",e.jsx("code",{children:"long long"})," at least 8. Actual sizes are platform-dependent."]})}),e.jsx(l,{title:"Type Investigation",difficulty:"beginner",prompt:"Write a program that prints the size of every fundamental type on your system using sizeof. Also print the maximum value of int and the minimum value of int using <climits>.",hints:["Include <climits> for INT_MAX and INT_MIN","sizeof returns the size in bytes"]}),e.jsx(x,{references:[{type:"cppreference",title:"Fundamental types",url:"https://en.cppreference.com/w/cpp/language/types",description:"Complete reference for all C++ fundamental types"},{type:"cppreference",title:"Fixed width integer types",url:"https://en.cppreference.com/w/cpp/types/integer",description:"int32_t, uint64_t, etc. from <cstdint>"}]})]})}const Y=Object.freeze(Object.defineProperty({__proto__:null,default:L},Symbol.toStringTag,{value:"Module"}));function E(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"Variables are named storage locations in memory. In C++, every variable has a type, a name, and a value. Understanding how to declare, initialize, and use variables — along with the difference between variables and constants — is fundamental to writing C++ programs."}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Declaration and Initialization"}),e.jsx(d,{title:"Variable Declaration",children:e.jsx(t,{children:`type name;              // Declaration (uninitialized)
...
d = 42
e = 0`}),e.jsxs(m,{title:"Uninitialized Variables",children:[e.jsxs("p",{children:["Reading an uninitialized variable is ",e.jsx("strong",{children:"undefined behavior"}),". The variable contains whatever was previously in that memory location. Always initialize your variables."]}),e.jsx(t,{children:`int x;
...
int y = 3.14;    // OK but silently truncates to 3 — potential bug!`})]}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Constants"}),e.jsx(d,{title:"const and constexpr",children:e.jsx(t,{children:`const double PI = 3.14159265358979;      // Runtime constant
...
double: 42
long: 42`}),e.jsxs(m,{title:"Dangerous Implicit Conversions (Narrowing)",children:[e.jsx("p",{children:"Narrowing conversions lose data silently. The compiler may warn but will still compile:"}),e.jsx(t,{children:`double pi = 3.14159;
int truncated = pi;     // 3 — fractional part silently lost!

int big = 300;
char c = big;           // Overflow! char can only hold -128 to 127

unsigned int u = -1;    // Wraps to 4294967295!`})]}),e.jsxs(a,{type:"tip",title:"Brace Initialization Catches Narrowing",children:[e.jsx("p",{children:"This is why brace initialization is preferred — it makes narrowing conversions a compile error:"}),e.jsx(t,{children:`int x{3.14};   // ERROR: narrowing conversion
int y = 3.14;  // OK but truncates (potential bug)`})]}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Integer Promotion"}),e.jsxs(d,{title:"Arithmetic Promotion Rules",children:[e.jsxs("p",{children:["In arithmetic expressions, smaller integer types are promoted to ",e.jsx("code",{children:"int"}),' before the operation is performed. If the operands have different types, the "narrower" one is converted to the "wider" one:']}),e.jsx("p",{className:"mt-2 font-mono text-xs text-gray-600 dark:text-gray-400",children:"bool → char → short → int → unsigned int → long → unsigned long → long long → float → double → long double"})]}),e.jsx(t,{children:`#include <iostream>
...
sizeof(a + b): 4
7 + 2.5 = 9.5`}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Explicit Casts"}),e.jsx("p",{className:"text-gray-700 dark:text-gray-300",children:"C++ provides four named cast operators. Each serves a specific purpose:"}),e.jsxs(d,{title:"static_cast — The Standard Cast",children:[e.jsxs("p",{children:["Use ",e.jsx("code",{children:"static_cast"})," for well-defined conversions between related types. This is the most common cast and should be your default choice."]}),e.jsx(t,{children:`double pi = 3.14159;
...
with cast: 3.5
99.9 → int: 99`}),e.jsxs(a,{type:"info",title:"Other Cast Types",children:[e.jsx("p",{children:"C++ has three other casts for specialized purposes:"}),e.jsxs("ul",{className:"list-disc pl-5 mt-1 space-y-1",children:[e.jsxs("li",{children:[e.jsx("code",{children:"const_cast"})," — removes or adds const (rarely needed)"]}),e.jsxs("li",{children:[e.jsx("code",{children:"dynamic_cast"})," — safe downcasting in class hierarchies (OOP topic)"]}),e.jsxs("li",{children:[e.jsx("code",{children:"reinterpret_cast"})," — low-level bit reinterpretation (advanced/dangerous)"]})]})]}),e.jsxs(m,{title:"Avoid C-Style Casts",children:[e.jsxs("p",{children:["C-style casts like ",e.jsx("code",{children:"(int)3.14"})," still work in C++ but are dangerous — they can perform any cast, including unsafe ones, with no compiler checks. Always use C++ named casts."]}),e.jsx(t,{children:`// Bad: C-style cast (avoid)
int x = (int)3.14;
...
42 → bool: true
true → int: 1`}),e.jsx(p,{title:"Be Explicit About Conversions",children:e.jsxs("p",{children:["When you need a type conversion, use ",e.jsx("code",{children:"static_cast"})," to document your intent. This makes the conversion visible to other developers and to code review tools. Let narrowing conversions be caught by brace initialization wherever possible."]})}),e.jsx(l,{title:"Safe Division",difficulty:"beginner",prompt:"Write a function that performs integer division but returns a double result (e.g., divide(7, 2) should return 3.5, not 3). Use static_cast.",hints:["Cast at least one operand to double before dividing","If both operands are int, the result will be truncated"],solution:e.jsx(t,{children:`#include <iostream>
...
int main() {
    ...
    return 0;
}`})}),e.jsx(x,{references:[{type:"cppreference",title:"Implicit conversions",url:"https://en.cppreference.com/w/cpp/language/implicit_conversion",description:"All implicit conversion rules"},{type:"cppreference",title:"static_cast",url:"https://en.cppreference.com/w/cpp/language/static_cast",description:"The standard explicit cast operator"},{type:"textbook",title:"Effective Modern C++",author:"Scott Meyers",description:"Item 2: Understand auto type deduction"}]})]})}const X=Object.freeze(Object.defineProperty({__proto__:null,default:F},Symbol.toStringTag,{value:"Module"}));function P(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"Arithmetic operators let you perform mathematical calculations in C++. Understanding how they behave with different data types — especially the difference between integer and floating-point division — is essential for writing correct programs."}),e.jsx(c,{title:"Arithmetic Operators",children:e.jsxs("p",{children:["C++ provides five basic arithmetic operators: addition (",e.jsx("code",{children:"+"}),"), subtraction (",e.jsx("code",{children:"-"}),"), multiplication (",e.jsx("code",{children:"*"}),"), division (",e.jsx("code",{children:"/"}),"), and modulo (",e.jsx("code",{children:"%"}),"). These work on numeric types and follow standard mathematical precedence rules."]})}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Basic Arithmetic"}),e.jsx(t,{title:"arithmetic_basics.cpp",children:`#include <iostream>
...
Float:    17.0 / 5 = 3.4
Cast:     3.4
Negative: -17 / 5 = -3`}),e.jsx(m,{title:"Division by Zero",children:e.jsxs("p",{children:["Dividing an integer by zero causes ",e.jsx("strong",{children:"undefined behavior"})," — your program may crash, produce garbage, or behave unpredictably. Floating-point division by zero produces infinity or NaN. Always validate divisors before dividing."]})}),e.jsxs(d,{title:"The Modulo Operator (%)",children:[e.jsxs("p",{children:["The modulo operator returns the ",e.jsx("strong",{children:"remainder"})," of integer division. It only works with integer types. The result has the same sign as the dividend (left operand)."]}),e.jsx(t,{children:`int remainder = 17 % 5;   // 2
...
x++   = 6
x now = 7
--x   = 6`}),e.jsx(p,{title:"Prefer prefix increment",children:e.jsxs("p",{children:["When you do not need the old value, prefer ",e.jsx("code",{children:"++x"})," over ",e.jsx("code",{children:"x++"}),". For built-in types the difference is negligible, but for iterators and user-defined types, prefix increment avoids creating an unnecessary temporary copy."]})}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Compound Assignment Operators"}),e.jsxs(d,{title:"Compound Assignment",children:[e.jsx("p",{children:"Compound assignment operators combine an arithmetic operation with assignment. They are shorthand that makes code more concise and sometimes more efficient."}),e.jsx(t,{children:`x += 5;   // same as x = x + 5
x -= 3;   // same as x = x - 3
x *= 2;   // same as x = x * 2
x /= 4;   // same as x = x / 4
...
int main() {
    ...
    return 0;
}`})}),e.jsx(l,{title:"Digit Extractor",difficulty:"intermediate",prompt:"Given the integer 7364, use division and modulo to extract and print each digit separately (ones, tens, hundreds, thousands).",hints:["The ones digit is number % 10","Divide by 10 to shift digits right, then use % 10 again"],solution:e.jsx(t,{children:`#include <iostream>
...
Found early, no further checks`}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Operator Precedence"}),e.jsxs(d,{title:"Precedence Order (High to Low)",children:[e.jsx("p",{children:"When mixing operators, precedence determines the order of evaluation. From highest to lowest among common operators:"}),e.jsx(t,{children:`!          // NOT (highest among logical)
* / %      // Multiplicative
+ -        // Additive
< <= > >=  // Relational
== !=      // Equality
&&         // Logical AND
||         // Logical OR (lowest)`})]}),e.jsx(p,{title:"Use Parentheses for Clarity",children:e.jsxs("p",{children:["Even when operator precedence gives you the correct result, adding parentheses makes your intent explicit and prevents mistakes. Write ",e.jsx("code",{children:"(a > 0) && (b < 10)"}),"rather than relying on the reader to know that comparison binds tighter than logical AND."]})}),e.jsx(a,{type:"tip",title:"Comparing Floating-Point Numbers",children:e.jsxs("p",{children:["Due to rounding errors, avoid comparing floating-point numbers with ",e.jsx("code",{children:"=="}),". Instead, check if the difference is within a small tolerance:",e.jsx("code",{children:" std::abs(a - b) < 0.0001"})]})}),e.jsx(l,{title:"Leap Year Checker",difficulty:"intermediate",prompt:"Write a program that checks whether the year 2024 is a leap year. A year is a leap year if it is divisible by 4, except for years divisible by 100, unless also divisible by 400.",hints:["Use % to check divisibility (year % 4 == 0)","Combine conditions with && and || to match the rule","The full condition: (divisible by 400) OR (divisible by 4 AND NOT divisible by 100)"],solution:e.jsx(t,{children:`#include <iostream>
...
int main() {
    ...
    return 0;
}`})}),e.jsx(x,{references:[{type:"cppreference",title:"Comparison Operators",url:"https://en.cppreference.com/w/cpp/language/operator_comparison",description:"Reference for all comparison operators"},{type:"cppreference",title:"Logical Operators",url:"https://en.cppreference.com/w/cpp/language/operator_logical",description:"Logical AND, OR, and NOT operators"},{type:"cppreference",title:"Operator Precedence",url:"https://en.cppreference.com/w/cpp/language/operator_precedence",description:"Complete precedence and associativity table"}]})]})}const K=Object.freeze(Object.defineProperty({__proto__:null,default:M},Symbol.toStringTag,{value:"Module"}));function R(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"Bitwise operators work directly on the individual bits of integer values. They are essential in systems programming, embedded development, graphics, networking, and anywhere you need fine-grained control over data at the binary level."}),e.jsx(c,{title:"Bitwise Operators",children:e.jsxs("p",{children:["C++ provides six bitwise operators: AND (",e.jsx("code",{children:"&"}),"), OR (",e.jsx("code",{children:"|"}),"), XOR (",e.jsx("code",{children:"^"}),"), NOT (",e.jsx("code",{children:"~"}),"), left shift (",e.jsx("code",{children:"<<"}),"), and right shift (",e.jsx("code",{children:">>"}),"). They operate on each bit of their integer operands independently."]})}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Bitwise AND, OR, XOR, and NOT"}),e.jsxs(d,{title:"Truth Table",children:[e.jsx("p",{children:"Each bitwise operator applies a logic operation to corresponding bits of two operands (or inverts bits for NOT):"}),e.jsx(t,{children:`// A & B  (AND): 1 only if both bits are 1
...
After clear, can read: no`}),e.jsx(p,{title:"Use Named Constants for Bit Flags",children:e.jsxs("p",{children:["Always define named constants for your bit flags rather than using raw numbers. Use ",e.jsx("code",{children:"constexpr"})," or ",e.jsx("code",{children:"enum"})," to give each flag a meaningful name. This makes the code self-documenting and prevents errors from mistyped values."]})}),e.jsx(a,{type:"info",title:"Practical Uses of Bitwise Operators",children:e.jsxs("p",{children:["Beyond flags, bitwise operators are used for fast multiplication and division by powers of 2, extracting color channels from packed pixel data (e.g., ",e.jsx("code",{children:"(pixel >> 8) & 0xFF"}),"for the green channel), implementing hash functions, and working with network protocols."]})}),e.jsx(a,{type:"history",title:"Origins",children:e.jsx("p",{children:"Bitwise operators originated in C and were inherited by C++. They map directly to CPU instructions, making them extremely fast. In the early days of computing, when memory was scarce, packing multiple values into a single integer using bit fields was a critical optimization technique."})}),e.jsx(l,{title:"Swap Without Temporary",difficulty:"intermediate",prompt:"Write a program that swaps two integers (a = 5, b = 9) using only XOR bitwise operations, without a temporary variable. Print the values before and after the swap.",hints:["XOR has the property: a ^ a == 0 and a ^ 0 == a","Step 1: a = a ^ b, Step 2: b = a ^ b, Step 3: a = a ^ b"],solution:e.jsx(t,{children:`#include <iostream>
...
int main() {
    ...
    return 0;
}`}),e.jsx(p,{title:"Always Validate User Input",children:e.jsxs("p",{children:["Never assume user input is correct. Check ",e.jsx("code",{children:"std::cin.fail()"})," after reading, and handle errors gracefully. Clear the error state with ",e.jsx("code",{children:"std::cin.clear()"}),"and discard remaining bad input with ",e.jsx("code",{children:"std::cin.ignore()"})," before attempting to read again."]})}),e.jsx(a,{type:"tip",title:"Mixing cin >> and getline",children:e.jsxs("p",{children:["After using ",e.jsx("code",{children:"std::cin >>"}),", a newline character remains in the input buffer. If you follow with ",e.jsx("code",{children:"std::getline()"}),", it reads that leftover newline as an empty string. Fix this by calling ",e.jsx("code",{children:"std::cin.ignore()"})," between them."]})}),e.jsx(l,{title:"Simple Calculator",difficulty:"beginner",prompt:"Write a program that reads two doubles and an operator character (+, -, *, /) from the user, performs the calculation, and prints the result formatted to 2 decimal places.",hints:["Use std::cin >> to read two doubles and a char","Use if/else or switch to select the operation","Use std::fixed and std::setprecision(2) for formatting"],solution:e.jsx(t,{children:`#include <iostream>
#include <iomanip>
...
int main() {
    ...
    return 0;
}`})}),e.jsx(x,{references:[{type:"cppreference",title:"std::cin",url:"https://en.cppreference.com/w/cpp/io/cin",description:"Standard input stream"},{type:"cppreference",title:"std::cout",url:"https://en.cppreference.com/w/cpp/io/cout",description:"Standard output stream"},{type:"cppreference",title:"Input/Output Manipulators",url:"https://en.cppreference.com/w/cpp/io/manip",description:"setw, setprecision, fixed, and other formatting manipulators"}]})]})}const Q=Object.freeze(Object.defineProperty({__proto__:null,default:B},Symbol.toStringTag,{value:"Module"}));function D(){return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:["Text handling is fundamental to most programs. C++ provides ",e.jsx("code",{children:"std::string"}),", a powerful and safe string class that manages memory automatically and offers a rich set of operations for searching, modifying, and comparing text."]}),e.jsx(c,{title:"std::string",children:e.jsxs("p",{children:[e.jsx("code",{children:"std::string"})," is a class defined in the ",e.jsx("code",{children:"<string>"})," header that represents a sequence of characters. Unlike C-style character arrays, it manages its own memory, grows dynamically, and provides bounds checking through its member functions."]})}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Creating and Using Strings"}),e.jsx(t,{title:"string_basics.cpp",children:`#include <iostream>
#include <string>
...
Your name has 13 characters.`}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"C-Strings vs std::string"}),e.jsxs(d,{title:"C-Strings",children:[e.jsxs("p",{children:["C-style strings are null-terminated character arrays inherited from C. They require manual memory management and use functions from ",e.jsx("code",{children:"<cstring>"}),"like ",e.jsx("code",{children:"strlen()"}),", ",e.jsx("code",{children:"strcpy()"}),", and ",e.jsx("code",{children:"strcmp()"}),"."]}),e.jsx(t,{children:`// C-style string (avoid in modern C++)
...
int len2 = str.length();        // member function`})]}),e.jsx(m,{title:"Avoid C-Strings in Modern C++",children:e.jsxs("p",{children:["C-style strings are error-prone: they can overflow buffers, require manual null termination, and lack bounds checking. Always prefer ",e.jsx("code",{children:"std::string"})," unless you are interfacing with C libraries or need low-level control."]})}),e.jsx(p,{title:"Use std::string by Default",children:e.jsxs("p",{children:["Always use ",e.jsx("code",{children:"std::string"})," for text in C++ programs. It handles memory management, supports comparison with ",e.jsx("code",{children:"=="}),", concatenation with ",e.jsx("code",{children:"+"}),", and provides safe access methods. Convert to C-strings only when needed using ",e.jsx("code",{children:".c_str()"}),"."]})}),e.jsx(a,{type:"info",title:"Useful String Methods",children:e.jsxs("p",{children:["Other handy methods include ",e.jsx("code",{children:"empty()"})," to check if a string is empty,",e.jsx("code",{children:"clear()"})," to erase contents, ",e.jsx("code",{children:"append()"})," to add text,",e.jsx("code",{children:"insert()"})," to insert at a position, ",e.jsx("code",{children:"erase()"})," to remove characters, and ",e.jsx("code",{children:"rfind()"})," to search backwards."]})}),e.jsx(l,{title:"Word Counter",difficulty:"beginner",prompt:"Write a program that reads a sentence using getline and counts how many spaces it contains. The number of words is approximately the number of spaces plus one.",hints:["Use std::getline to read the full sentence","Loop through each character and count spaces","You can use a range-based for loop: for (char c : sentence)"],solution:e.jsx(t,{children:`#include <iostream>
#include <string>
...
2: Age: 30
3: Score: 95.5`}),e.jsx(p,{title:"Always Check if the File Opened",children:e.jsxs("p",{children:["Always verify that a file stream opened successfully using ",e.jsx("code",{children:"is_open()"})," or by testing the stream in a boolean context. A file might fail to open because it does not exist, permissions are insufficient, or the path is invalid. Proceeding without checking leads to silent data loss."]})}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"File Open Modes"}),e.jsxs(d,{title:"File Modes",children:[e.jsxs("p",{children:["You can control how a file is opened by passing mode flags to the constructor or the ",e.jsx("code",{children:"open()"})," method. Multiple modes can be combined with the bitwise OR operator (",e.jsx("code",{children:"|"}),")."]}),e.jsx(t,{children:`std::ios::in      // Open for reading (default for ifstream)
...
int main() {
    ...
    return 0;
}`}),e.jsx(a,{type:"important",title:"RAII and File Streams",children:e.jsxs("p",{children:["File streams automatically close when they go out of scope thanks to their destructor. Calling ",e.jsx("code",{children:".close()"})," explicitly is not strictly necessary, but it is good practice when you want to ensure data is flushed before proceeding, or when you want to reuse the stream object for another file."]})}),e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-gray-100",children:"Reading Structured Data"}),e.jsx(t,{title:"structured_read.cpp",children:`#include <iostream>
#include <fstream>
#include <string>
...
Alice: 89
Bob: 80.6667
Carol: 91.6667`}),e.jsx(m,{title:"Error Checking During Reads",children:e.jsxs("p",{children:["When reading structured data, a malformed file can put the stream into a fail state. Always check the stream state after reading. The ",e.jsx("code",{children:"while (stream >> var)"}),"idiom naturally handles end-of-file and errors by stopping the loop when a read fails."]})}),e.jsx(a,{type:"tip",title:"Relative vs Absolute Paths",children:e.jsxs("p",{children:["File paths without a leading ",e.jsx("code",{children:"/"}),' (on Linux/macOS) or drive letter (on Windows) are relative to the current working directory — which may not be the directory containing your program. When debugging "file not found" errors, print the current directory or use absolute paths.']})}),e.jsx(l,{title:"File Copy Program",difficulty:"beginner",prompt:"Write a program that creates a file called 'source.txt' with three lines of text, then reads it and writes its contents to 'copy.txt'. Verify by reading and printing 'copy.txt'.",hints:["Open an ofstream for source.txt, write lines, then close it","Open an ifstream for source.txt and an ofstream for copy.txt","Use getline in a loop to read from source and write to copy"],solution:e.jsx(t,{children:`#include <iostream>
#include <fstream>
#include <string>
