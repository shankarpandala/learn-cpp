          ...
          {sections.map((section, idx) => {
            ...
            return (
              ...
              >
                <Link
                  to={to}
                  className={`group flex items-start gap-4 rounded-xl border p-4 transition-all hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
                    done
                      ? 'border-emerald-200 bg-emerald-50/50 dark:border-emerald-900/40 dark:bg-emerald-950/20'
                      : 'border-gray-200 bg-white hover:border-blue-200 hover:bg-blue-50/30 dark:border-gray-800 dark:bg-gray-900 dark:hover:border-blue-800/50 dark:hover:bg-blue-950/10'
                  }`}
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex flex-wrap items-start justify-between gap-2">
                      <h3
                        className={`font-semibold leading-snug group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors ${
