      ...
      >
        ...
        <div className="mx-auto max-w-5xl px-6 py-10 pl-10">
          ...
          <div className="mt-4 flex items-start gap-5">
            <div
              className="hidden sm:flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl text-2xl font-bold shadow-sm font-mono"
                  ...
                  {subject.prerequisites.map((prereqId) => {
                    ...
                    return prereq ? (
                      <Link
                        ...
                        className="rounded-full border border-gray-200 bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-700 hover:border-blue-300 hover:text-blue-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:border-blue-600 dark:hover:text-blue-400 transition-colors"
                      >
                        {prereq.title}
                      </Link>
                    ) : (
